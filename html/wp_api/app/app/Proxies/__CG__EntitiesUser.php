...
class User extends \Entities\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        $this->__load();
        return parent::setEmailVerifyHash($emailVerifyHash);
    }

    public function getEmailVerifyHash()
    {
        $this->__load();
        return parent::getEmailVerifyHash();
    }

    public function setBillingDate($billingDate)
    {
        $this->__load();
        return parent::setBillingDate($billingDate);
    }

    public function getBillingDate()
    {
        $this->__load();
        return parent::getBillingDate();
    }


    public function __sleep()
    {
        return array('__isInitialized__', 'id', 'userName', 'password', 'name', 'email', 'adults', 'children', 'goal', 'registeredDate', 'active', 'account', 'subscription', 'lastLoggedIn', 'timesLoggedIn', 'customerToken', 'emailVerifyHash', 'billingDate', 'rank');
    }
