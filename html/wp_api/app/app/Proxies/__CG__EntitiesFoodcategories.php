 ...
 */
class Foodcategories extends \Entities\Foodcategories implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        $this->__load();
        return parent::setFoodCategory($foodCategory);
    }

    public function getFoodCategory()
    {
        $this->__load();
        return parent::getFoodCategory();
    }
    ...
    {
        return array('__isInitialized__', 'id', 'foodCategory', 'image', 'percentage', 'fk_userId');
    }
